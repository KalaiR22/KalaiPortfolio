...
const Header = () => {
  ...
  return (
    <div className="relative z-50">
      <div className="bg-black fixed top-0 left-0 right-0 flex justify-between shadow-xl shadow-black/40 rounded-md items-center px-4 sm:px-10 xl:px-14 2xl:px-28 py-4 h-20">
